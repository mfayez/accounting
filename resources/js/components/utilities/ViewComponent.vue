    ...
    <div class="mb-16">
        <div class="flex flex-col items-center justify-between md:flex-row">
            ...
            <div class="flex items-center mt-4 space-x-4 md:mt-0">
                <app-button
                    @click="rtl = !rtl"
                    class="p-1 rounded-md hover:text-gray-700 hover:bg-gray-400 focus:outline-none"
                    :class="
                        rtl
                ...
                <app-button
                    @click="dark = !dark"
                    class="p-1 text-gray-600 bg-gray-200 rounded-md hover:text-gray-700 hover:bg-gray-400 focus:outline-none"
        ...
        <div :class="{ dark: dark }">
            <div
                class="flex items-center justify-center mt-4 overflow-hidden bg-gray-100 border border-gray-100 rounded-lg dark:bg-gray-900 dark:border-gray-900"
            >
                <div class="relative w-full" :dir="rtl ? 'rtl' : 'ltr'">
                    ...
                    <transition name="fade">
                        <div v-if="copied">
                            ...
                            >
                                <div
                                    class="flex items-center justify-center h-full bg-gray-200 dark:bg-gray-700"
                                >
                                    <p
