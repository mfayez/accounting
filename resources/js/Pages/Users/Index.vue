<template>
    <app-layout>
        ...
        <div class="py-4">
            <div v-if="$page.props.user.is_admin" class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div
                    ...
                    >
                        ...
                        <template #body>
                            <tr v-for="user in users.data" :key="user.id">
                                ...
                                <td>
                                    <button
                                        class="p-1 rounded-md bg-green-500 text-white hover:bg-green-600 mx-2"
                                        @click="edituser(user)"
                                    >
                                        <svg
                                    ...
                                    <button
                                        class="p-1 rounded-md bg-red-500 text-white hover:bg-red-600 mx-2"
                                        i
